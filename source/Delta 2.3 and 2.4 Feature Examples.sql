...
-- MAGIC %md
-- MAGIC
-- MAGIC ## Create OOTB configured tables with Cluster Policy enforcements
-- MAGIC
-- MAGIC ! Using Cody UC Cluster
...
DESCRIBE DETAIL policy_table;

-- COMMAND ----------

-- DBTITLE 1,Commands that now run on ALL clusters with the policy
--SET spark.databricks.delta.properties.defaults.enableChangeDataFeed = true;
--SET spark.databricks.delta.properties.defaults.minReaderVersion = 1;
